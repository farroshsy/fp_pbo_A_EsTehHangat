...
public class PlayerShip extends Model {
	...
	public PlayerShip() {
		super("Group 22 (1)", WindowManager.LIMIT_LEFT, WindowManager.LIMIT_DOWN - SIZE_Y * WindowManager.ZOOM, SIZE_X * WindowManager.ZOOM, SIZE_Y * WindowManager.ZOOM);
		this.left = false;
		this.right = false;
		this.shootTime = 0;
		this.shootDelay = 30;
